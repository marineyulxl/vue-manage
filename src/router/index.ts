    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                component: () => import(/* webpackChunkName: "dashboard" */ '../views/product.vue'),
            },
            {
                path: '/order',
                name: 'order',
            ...
            },
            {
                ...
                component: () => import(/* webpackChunkName: "dashboard" */ '../views/swiper.vue'),
            },
            {
                path: '/table',
                name: 'basetable',
...
router.beforeEach((to, from, next) => {
    document.title = `${to.meta.title} | 农产品后台管理`;
